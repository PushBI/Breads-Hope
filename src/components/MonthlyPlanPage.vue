<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <!-- Page Header -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">My Monthly Report</h1>
        <p class="text-gray-600 mt-2">Create and manage your monthly report</p>
      </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">
                  Strength in Each Group <span class="text-red-500">*</span>
                </label>
                <input
                  v-model.number="formData.strengthPerGroup"
                  type="number"
                  min="1"
                  required
                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-900 focus:border-transparent"
                  placeholder="Enter strength per group"
                />
              </div>
            </div>
          </div>
...
const handleSubmit = () => {
  console.log('Monthly report Submitted:', formData)
